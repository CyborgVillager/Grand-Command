...
try:
    ...
    print('Cannot draw images @ gc_tileinfo.py @ function def draw')
...
try:
    ...
    print('Error @ gc_tileinfo.py function def gen_Board')
...
try:
    ...
    print('Error @ gc_tileinfo.py fuynction def boardUpSize')