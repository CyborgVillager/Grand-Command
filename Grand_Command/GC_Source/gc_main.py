    ...
    while game_run == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pos[0] >= 445 and pos[0] <= 545 and pos[1] >= 400 and pos[
                    1] <= 450 and Confirming == True and ConfirmMessage == "You have collected 10k Mandorium":
                    PrestigeCount = 0
                    for item in Mult:
                        Mult[item] *= 10
                    AscendCount += 1
                        ...
                        for event in pygame.event.get():
                            ...
                            if event.type == pygame.MOUSEBUTTONDOWN:
                                ...
                                if pos[0] >= 600 and pos[0] <= 800 and pos[1] >= 175 and pos[1] <= 275:
                                    ...
                                    Tiles = ["Grass", "City", "Factory", "Factory Su", "Factory So", "Solar Power",
                                             "Super Factory", "Forest Lv1", "Forest Lv2", "Forest Lv3"
                                        , "Forest Lv4", "Quarry Lv1", "Quarry Lv2", "Quarry Lv3", "Quarry Lv4", "Water",
                                             "Water Dam", "Water Fish", "Fisherman", "Dam"
                                        , "CityFar", "CityFac", "Farm"]
                                    for j in range(height):
                                        for i in range(width):
                                            Data += str(Tiles.index(board[j][i])) + "#"
                                    ...
                                    if ask.count("#") >= 90:
                                        ...
                                        if DataList[Count] == "Beta1.6":
                                            ...
                                            Tiles = ["Grass", "City", "Factory", "Factory Su", "Factory So",
                                                     "Solar Power", "Super Factory", "Forest Lv1", "Forest Lv2",
                                                     "Forest Lv3"
                                                , "Forest Lv4", "Quarry Lv1", "Quarry Lv2", "Quarry Lv3", "Quarry Lv4",
                                                     "Water", "Water Dam", "Water Fish", "Fisherman", "Dam"
                                                , "CityFar", "CityFac", "Farm"]
                                            for j in range(height):
                                                for i in range(width):
                                                    board[j][i] = Tiles[int(DataList[Count])]
                ...
                if pos[0] >= 725 and pos[0] <= 925 and pos[1] >= 550 and pos[1] <= 650 and CurSelection != [-1, -1]:
                    ...
                    if board[CurSelection[1]][CurSelection[0]] == "CityFac" and ResourceCount["Food"] >= 1 and \
                            ResourceCount["Stones"] >= 50 and Achievments[1]["Finished"] == True:
                    ...
                    if board[CurSelection[1]][CurSelection[0]] == "Water Fish" and ResourceCount["Wood"] >= 100 and \
                            ResourceCount["Metal"] >= 25 and Achievments[5]["Finished"] == True:
                    ...
                    if board[CurSelection[1]][CurSelection[0]] == "CityFar" and ResourceCount["Wood"] >= 100 and \
                            ResourceCount["Food"] >= 50 and Achievments[1]["Finished"] == True:
                        ResourceCount["Wood"] -= 100
                    ...
                    if board[CurSelection[1]][CurSelection[0]] == "Grass" and ResourceCount["Wood"] >= 50 and \
                            ResourceCount["Stones"] >= 20 and UnUpgradable[1] != "Grass":
                    ...
                    if board[CurSelection[1]][CurSelection[0]] == "Water Dam" and ResourceCount["Wood"] >= 200 and \
                            ResourceCount["Metal"] >= 50 and Achievments[2]["Finished"] == True:
                ...
                if CurSelection == [-1, -1] and pos[0] >= 725 and pos[0] <= 925 and pos[1] >= 550 and pos[1] <= 650 and \
                        ResourceCount["Wood"] >= 1000 and ResourceCount["Stones"] >= 500 and ResourceCount[
                    "Food"] >= 200 and ResourceCount["Metal"] >= 100 and ResourceCount["Electricity"] >= 50:
                    Earned = 0
                    Tiles = ["Grass", "City", "Factory", "Factory Su", "Factory So", "Solar Power", "Super Factory",
                             "Forest Lv1", "Forest Lv2", "Forest Lv3"
                        , "Forest Lv4", "Quarry Lv1", "Quarry Lv2", "Quarry Lv3", "Quarry Lv4", "Water", "Water Dam",
                    ...
                    Earned += int(ResourceCount["Wood"] / 1000) + int(ResourceCount["Stones"] / 500) + int(
                        ResourceCount["Food"] / 200) + int(ResourceCount["Metal"] / 100) + int(
                        ResourceCount["Electricity"] / 50)
                    PrestigeCount += 1
